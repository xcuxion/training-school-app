      ...
      <div className="w-full pt-16 flex flex-start relative">
        <div className="w-2/3">
          ...
          <p className="text-lg w-4/5">
            ...
            entrepreneur has the potential to become a hero in the digital age.
            Our three tiered adventure is designed to awaken your powers, hone
            your skills, and launch you into the stratosphere of tech success.
          </p>
        </div>
        <Image
          ...
          width={300}
          height={300}
          className=" w-[650px] mb-[-48px] z-[-10]"
        />
      </div>
      <Levels />
    </section>
