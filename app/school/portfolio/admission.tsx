    ...
    >
      ...
      >
        ...
        <ul className="list-disc list-inside text-left space-y-3 text-base md:text-lg text-gray-200">
          ...
          <li>
            Shortlisted candidates will be invited for an interview (virtual or
            in-person).
          </li>
          <li>
            Selection is based on merit, financial need, and commitment to
      ...
      >
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4 text-primary leading-tight">
